...
import { Brush, Eraser, Hand, MousePointer2, Scan, Type, WandSparkles, Stamp } from 'lucide-react';
...
const tools: Array<{ tool: ActiveTool; label: string; hotkey: string; icon: typeof Brush; tab?: LeftTab }> = [
  ...
  { tool: 'wand', label: 'Волшебный бабл', hotkey: 'M', icon: WandSparkles, tab: 'cleanup' },
];
